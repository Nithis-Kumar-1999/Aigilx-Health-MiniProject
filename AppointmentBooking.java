...
class AppointmentBooking
{
	...
	void dataAdd()		
	{
		doctorName.add("Santhosh");
		doctorName.add("Philmon");
		doctorName.add("Ajith Kumar");
		doctorName.add("Gopinath");
		doctorName.add("Senthil");
		doctorName.add("Karthikeyan");
		doctorName.add("Munish Kumar");
		...
		doctorPassword.add("Santhosh123");
		doctorPassword.add("Philmon456");
		doctorPassword.add("Ajith Kumar789");
		doctorPassword.add("Gopinath101");
		doctorPassword.add("Senthil121");
		doctorPassword.add("Karthikeyan314");
		doctorPassword.add("Munish Kumar156");
		...
		doctorMobileNumber.add(9876543210l);
		doctorMobileNumber.add(9095432101l);
		doctorMobileNumber.add(8435672313l);
		doctorMobileNumber.add(9856432123l);
		doctorMobileNumber.add(9003359432l);
		doctorMobileNumber.add(7093949394l);
		doctorMobileNumber.add(8956770321l);

		doctorCity.add("Madurai");
		doctorCity.add("Tenkasi");
		doctorCity.add("Kovai");
			...
			while(flag)
			{
				...
				System.out.println("\t\t |_________________________|");
					...
					if(choice<=doctorName.size() && choice>0)
					{
						...
						System.out.println("\n Enter your name: \t");
						scn.nextLine();
						patientNameBooking.add(scn.nextLine());
						System.out.println(" Enter your age: \t");
						patientAgeBooking.add(scn.nextInt());
						System.out.println(" Enter your gender: \t");
						patientGenderBooking.add(scn.next());
	...
	void patientRegistration() throws Exception
	{
		...
		patientName.add(scn.nextLine());
		System.out.println("enter your age: ");
		patientAge.add(scn.nextInt());
			...
			long mno;
				...
				else 
				{
					...
					if(flag1==true)
					{
								...
								doctorAge.add(scn.nextInt());
								System.out.println("Enter City: ");
								doctorCity.add(scn.next());
								System.out.println("Enter password");
								doctorPassword.add(scn.next());
								System.out.println("Registration is Successfull.");
